...
let s:dark_pink = "#ff5f87"
let s:light_pink = "#d75f87"

let s:N1 = [ '#eeeeee' , s:guibg , 45  , s:termbg ]
let s:N2 = [ s:light_pink , s:guibg , 202 , s:termbg ]
...
let g:airline#themes#khw2#palette.normal_modified = {
      \ 'airline_c': [ s:light_pink , s:guibg, 160     , s:termbg    , ''     ] ,
      \ }

let s:I1 = [ '#eeeeee' , s:guibg , 82  , s:termbg ]
let s:I2 = [ s:light_pink , s:guibg , 202 , s:termbg ]
...
let g:airline#themes#khw2#palette.insert_paste = {
      \ 'airline_a': [ s:I1[0]   , s:dark_pink , s:I1[2] , 172     , ''     ] ,
      \ }

let g:airline#themes#khw2#palette.replace = {
      \ 'airline_a': [ s:I1[0]   , s:dark_pink , s:I1[2] , 124     , ''     ] ,
      \ }
...
let s:V2 = [ s:light_pink , s:guibg , 202 , s:termbg ]
